...
<div id="cadastrar"><a href="cadastro.php" title="Cadastre-se e faça parte da nossa equipe!">Cadastre-se &raquo;</a></div>
	<div id="login" class="form bradius">
        ...
        <div class="acomodar">
            ...
            <label for="email">Login: </label><input placeholder="Digite seu E-mail" id="email" type="text" class="txt bradius" name="email" value="" />
            <label for="senha">Senha: </label><input placeholder="Digite sua Senha" id="senha" type="password" class="txt bradius" name="senha" value="" />
